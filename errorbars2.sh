...
unset key 
Shadecolor = "#80E0A080"
plot 'data.dat' using 1:3:4 with filledcurve fc rgb Shadecolor title "Pression moyenne par station", '' using 1:3 with lines title "Moyenne"